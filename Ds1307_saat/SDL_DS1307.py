...
class SDL_DS1307():
    ...
    def read_all(self):
        ...
        return (self._read_year(), self._read_month(), self._read_date(),
                self._read_day(), self._read_hours()+2, self._read_minutes(),
                self._read_seconds())
    ...
    def read_str(self):
        ...
        return '%02d-%02d-%02dT%02d:%02d:%02d' % (self._read_year(),
                self._read_month(), self._read_date(), self._read_hours()+2,
    ...
    def write_all(self, seconds=None, minutes=None, hours=2, day=None,
        ...
        if hours is not None:
            ...
            if hours < 0 or hours > 23:
                ...
                raise ValueError('Hours is out of range [0,23] . {}'.format(hours))
